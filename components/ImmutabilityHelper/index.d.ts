...
export declare const extend: <T>(
  directive: string,
  fn: (param: any, old: T) => T
) => void;
declare const _default: <T, C extends CustomCommands<object> = never>(
  object: T,
  $spec: Spec<T, C>
) => T;
...
export declare type Spec<T, C extends CustomCommands<object> = never> =
